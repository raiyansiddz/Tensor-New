                ...
                >
                  <div className="glass-card h-full w-full flex items-center justify-center p-6 rounded-xl group hover:border-primary/30 transition-all duration-300">
                    <img
                      src={client.logo}
                      alt={client.name}
                      className="max-h-18 w-auto object-contain  dark:brightness-200 dark:invert-[0.30]transition-all duration-300"
                    />
                  </div>
                </motion.div>
              ))}
                    ...
                    {clients.map((client, index) => (
                      ...
                      >
                        <img
                          src={client.logo}
                          alt={client.name}
                          className="max-h-10 w-auto object-contain dark:brightness-20 dark:invert-[0.10]"
                        />
                      </div>
                    ))}
                  </div>
