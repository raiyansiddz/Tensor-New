...
const NavBar = () => {
  ...
  return (
    ...
    >
      <div className="container mx-full sm:px-2 lg:px-8 ">
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden fixed top-[4.5rem] left-0 right-0 z-40 px-2 pb-2 w-full max-h-[calc(100vh-5rem)] overflow-y-auto"
          >
            <div className="bg-background/90 backdrop-blur-lg border border-border/50 rounded-3xl shadow-lg p-2 w-full">
              ...
              {/* <div className="mt-2 max-h-[calc(100vh-12rem)] overflow-y-auto rounded-2xl">
                {navLinks.slice(4).map((link) =>
                  link.href.startsWith("https://") ? (
                    <a
                      key={link.name}
